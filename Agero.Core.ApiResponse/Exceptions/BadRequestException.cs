...
{
    /// <summary>Exception which will lead to 'Bad Request' (400) HTTP response</summary>
    public class BadRequestException : BaseException
    {
        ...
        public BadRequestException(string message, string code = ResponseCode.INVALID_REQUEST, object additionalData = null, Exception innerException = null) 
